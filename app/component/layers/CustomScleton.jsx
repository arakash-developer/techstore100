...
const CustomScletonOne = ({ className }) => {
    return (
        <div className={`${className}`}>
            <ShimmerThumbnail height={372} rounded />
        </div>
    )
}

const CustomScleton = ({ className }) => {
    return (
        <div className={`${className} w-[234px] h-[372px] bg-[var(--color---12)] relative`}>
