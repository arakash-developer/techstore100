...
import CustomScleton, { CustomScletonOne } from "./CustomScleton";
      ...
      <div className={`${className}`}>
        <Container className="max-w-[1404px]">
          ...
          {!loading && (
            <div className="grid grid-cols-12 h-[372px] items-start w-full">
              <div
                className={`xsm:w-[234px] lg:w-[166px] xl:w-[234px]  h-[372px] ${seriesImage} bg-no-repeat bg-cover bg-center lg:col-span-2 md:col-span-3 sm:col-span-4 xsm:col-span-6 hidden xsm:block`}
              >
                <div className="pt-[151px] pb-9">
                  <h3 className="max-w-[100px] mx-auto capitalize font-bold text-[1.38rem]  leading-[130%] text-center text-[var(--color---12)]">
                    {seriesTitle}
                  </h3>
                  <Link
                    href={seriesLink}
                    className="mt-[100px] block capitalize font-normal text-[0.81rem] underline leading-[115%] text-center text-[#fff]"
                  >
                    See All Products
                  </Link>
                </div>
